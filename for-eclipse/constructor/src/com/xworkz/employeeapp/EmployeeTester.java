...
public class EmployeeTester {
		...
		public static void main(String args[]) {
			...
			System.out.println(emp.employeeId + " "+ emp.name +" "+ emp.bloodGroup); write both are same*/
		     Employee emp = new Employee("AWS123","maha","0+");
			 System.out.println("company Details");
			 System.out.println(Employee.companyName +" "+Employee.companyAddress);
			...
			emp1.employeeId="AWS123";
			emp1.name="maha";
			emp1.bloodGroup="o+";
			System.out.println(Employee.companyName +" "+Employee.companyAddress);
			System.out.println(emp.employeeId + " "+ emp.name +" "+ emp.bloodGroup);*/
			 Employee emp1 = new Employee("AWS345","dolly","A+");
			 System.out.println("company Details");
			 System.out.println(Employee.companyName +" "+Employee.companyAddress);
			...
			emp2.employeeId="AWS123";
			emp2.name="maha";
			emp2.bloodGroup="o+";
			System.out.println(Employee.companyName +" "+Employee.companyAddress);
			System.out.println(emp.employeeId + " "+ emp.name +" "+ emp.bloodGroup);*/
			 Employee emp2 = new Employee("AWS789","teddy","AB+");
			 System.out.println("company Details");
			 System.out.println(Employee.companyName +" "+Employee.companyAddress);
